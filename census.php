...
<p <?php echo $displayNone; ?>>Please enter your dependents' information below, even if you do not plan to enroll for health insurance, or if you only intend to request coverage for yourself.  This census information will be used by Convo while comparing costs for health insurance vendors. It does <strong>NOT</strong> mean you will be enrolling them for health insurance.</p>
				...
				<tbody>
    				...
    				<tr id='dependent_information0' name="dependent_information0" data-id="0" class="hidden">
						<td data-name="firstname">
						    <input type="text" name='firstname0' placeholder='First Name' class="form-control" value="<?php if(isset($_POST["button"])){echo $_POST['firstname0'];} ?>"/>
						</td>
						...
						<td data-name="gender">
						    <select name="gender0">
                                ...
                                <option value="Male" <?php if(isset($_POST["button"]) && $_POST["gender0"] == "Male"){echo "selected='selected'";} ?>>Male</option>
                                <option value="Female" <?php if(isset($_POST["button"]) && $_POST["gender0"] == "Female"){echo "selected='selected'";} ?>>Female</option>                          
                            </select>
						</td>
    					<td data-name="relationship">
						    <select name="relationship0">
        				        <option value="">Select Option</option>
    					        <option value="Employee" <?php if(isset($_POST["button"]) && $_POST["relationship0"] == "Employee"){echo "selected='selected'";} ?>>Employee</option>
        				        <option value="Spouse/Domestic Partner" <?php if(isset($_POST["button"]) && $_POST["relationship0"] == "Spouse/Domestic Partner"){echo "selected='selected'";} ?>>Spouse/Domestic Partner</option>
        				        <option value="Child" <?php if(isset($_POST["button"]) && $_POST["relationship0"] == "Child"){echo "selected='selected'";} ?>>Child</option>
						    </select>
						</td>
					</tr>
                    ...
                    <tr id='dependent_information1' name="dependent_information1" data-id="1" class="hidden">
						<td data-name="firstname">
						    <input type="text" name='firstname1'  placeholder='First Name' class="form-control" value="<?php if(isset($_POST["button"])){echo $_POST['firstname1'];} ?>"/>
						</td>
						<td data-name="lastname">
						...
						<td data-name="gender">
						    <select name="gender1">
                                <option value="">Select one</option>
                                <option value="Male" <?php if(isset($_POST["button"]) && $_POST["gender1"] == "Male"){echo "selected='selected'";} ?>>Male</option>
                                <option value="Female" <?php if(isset($_POST["button"]) && $_POST["gender1"] == "Female"){echo "selected='selected'";} ?>>Female</option>                          
                            </select>
						</td>
    					<td data-name="relationship">
						    <select name="relationship1">
        				        <option value="">Select Option</option>
    					        <option value="Employee" <?php if(isset($_POST["button"]) && $_POST["relationship1"] == "Employee"){echo "selected='selected'";} ?>>Employee</option>
        				        <option value="Spouse/Domestic Partner" <?php if(isset($_POST["button"]) && $_POST["relationship1"] == "Spouse/Domestic Partner"){echo "selected='selected'";} ?>>Spouse/Domestic Partner</option>
        				        <option value="Child" <?php if(isset($_POST["button"]) && $_POST["relationship1"] == "Child"){echo "selected='selected'";} ?>>Child</option>
						    </select>
						</td>
					</tr>
                    ...
                    <tr id='dependent_information2' name="dependent_information2" data-id="2" class="hidden">
						<td data-name="firstname">
						    <input type="text" name='firstname2'  placeholder='First Name' class="form-control" value="<?php if(isset($_POST["button"])){echo $_POST['firstname2'];} ?>"/>
						</td>
						<td data-name="lastname">
						...
						<td data-name="gender">
						    <select name="gender2">
                                <option value="">Select one</option>
                                <option value="Male" <?php if(isset($_POST["button"]) && $_POST["gender2"] == "Male"){echo "selected='selected'";} ?>>Male</option>
                                <option value="Female" <?php if(isset($_POST["button"]) && $_POST["gender2"] == "Female"){echo "selected='selected'";} ?>>Female</option>                          
                            </select>
						</td>
    					<td data-name="relationship">
						    <select name="relationship2">
        				        <option value="">Select Option</option>
    					        <option value="Employee" <?php if(isset($_POST["button"]) && $_POST["relationship2"] == "Employee"){echo "selected='selected'";} ?>>Employee</option>
        				        <option value="Spouse/Domestic Partner" <?php if(isset($_POST["button"]) && $_POST["relationship2"] == "Spouse/Domestic Partner"){echo "selected='selected'";} ?>>Spouse/Domestic Partner</option>
        				        <option value="Child" <?php if(isset($_POST["button"]) && $_POST["relationship2"] == "Child"){echo "selected='selected'";} ?>>Child</option>
						    </select>
						</td>
					</tr>
                    ...
                    <tr id='dependent_information3' name="dependent_information3" data-id="3" class="hidden">
						<td data-name="firstname">
						    <input type="text" name='firstname3'  placeholder='First Name' class="form-control" value="<?php if(isset($_POST["button"])){echo $_POST['firstname3'];} ?>"/>
						</td>
						<td data-name="lastname">
						...
						<td data-name="gender">
						    <select name="gender3">
                                <option value="">Select one</option>
                                <option value="Male" <?php if(isset($_POST["button"]) && $_POST["gender3"] == "Male"){echo "selected='selected'";} ?>>Male</option>
                                <option value="Female" <?php if(isset($_POST["button"]) && $_POST["gender3"] == "Female"){echo "selected='selected'";} ?>>Female</option>                          
                            </select>
						</td>
    					<td data-name="relationship">
						    <select name="relationship3">
        				        <option value="">Select Option</option>
    					        <option value="Employee" <?php if(isset($_POST["button"]) && $_POST["relationship3"] == "Employee"){echo "selected='selected'";} ?>>Employee</option>
        				        <option value="Spouse/Domestic Partner" <?php if(isset($_POST["button"]) && $_POST["relationship3"] == "Spouse/Domestic Partner"){echo "selected='selected'";} ?>>Spouse/Domestic Partner</option>
        				        <option value="Child" <?php if(isset($_POST["button"]) && $_POST["relationship3"] == "Child"){echo "selected='selected'";} ?>>Child</option>
						    </select>
						</td>
					</tr>
                    ...
                    <tr id='dependent_information4' name="dependent_information4" data-id="4" class="hidden">
						<td data-name="firstname">
						    <input type="text" name='firstname4'  placeholder='First Name' class="form-control" value="<?php if(isset($_POST["button"])){echo $_POST['firstname4'];} ?>"/>
						</td>
						<td data-name="lastname">
						...
						<td data-name="gender">
						    <select name="gender4">
                                <option value="">Select one</option>
                                <option value="Male" <?php if(isset($_POST["button"]) && $_POST["gender4"] == "Male"){echo "selected='selected'";} ?>>Male</option>
                                <option value="Female" <?php if(isset($_POST["button"]) && $_POST["gender4"] == "Female"){echo "selected='selected'";} ?>>Female</option>                          
                            </select>
						</td>
    					<td data-name="relationship">
						    <select name="relationship4">
        				        <option value="">Select Option</option>
    					        <option value="Employee" <?php if(isset($_POST["button"]) && $_POST["relationship4"] == "Employee"){echo "selected='selected'";} ?>>Employee</option>
        				        <option value="Spouse/Domestic Partner" <?php if(isset($_POST["button"]) && $_POST["relationship4"] == "Spouse/Domestic Partner"){echo "selected='selected'";} ?>>Spouse/Domestic Partner</option>
        				        <option value="Child" <?php if(isset($_POST["button"]) && $_POST["relationship4"] == "Child"){echo "selected='selected'";} ?>>Child</option>
						    </select>
						</td>
					</tr>
