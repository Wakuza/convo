<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        if(empty($_POST["ssn"])){
            $errorSSN = "<span class='error'>Please enter last 9 digits ssn</span>";   
        }
        ...
        if(empty($_POST["emergencyName"])) {
            $errorEmergencyName = "<span class='error'> Please enter emergency name</span>"; 
        }
        if(empty($_POST["emergencyNumber"])) {
            $errorEmergencyNumber = "<span class='error'> Please enter emergency number</span>"; 
        }
